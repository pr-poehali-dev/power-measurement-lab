...
export default function Index() {
  ...
  const news = [
    {
      title: "Новая линейка цифровых осциллографов",
      date: "15 июля 2025",
      description: "Представлена серия высокоточных осциллографов с расширенными возможностями анализа сигналов"
    },
    {
      title: "Сертификация ISO 9001:2015",
      date: "10 июля 2025", 
      description: "Институт успешно прошел аудит системы менеджмента качества"
    },
    {
      title: "Партнерство с ведущими вузами",
      date: "5 июля 2025",
      description: "Заключены соглашения о сотрудничестве с техническими университетами страны"
    }
  ];
